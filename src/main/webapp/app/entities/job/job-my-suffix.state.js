    ...
    function stateConfig($stateProvider) {
        ...
        .state('job-my-suffix', {
            ...
            data: {
                ...
                pageTitle: 'demo2App.job.home.title'
            },
            views: {
                'content@': {
        ...
        .state('job-my-suffix-detail', {
            ...
            data: {
                authorities: ['ROLE_USER'],
                pageTitle: 'demo2App.job.detail.title'
            },
            views: {
                'content@': {
                    templateUrl: 'app/entities/job/job-my-suffix-detail.html',
        ...
        .state('job-my-suffix-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/job/job-my-suffix-dialog.html',
        ...
        .state('job-my-suffix.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/job/job-my-suffix-delete-dialog.html',
