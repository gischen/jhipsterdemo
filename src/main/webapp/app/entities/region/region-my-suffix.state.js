    ...
    function stateConfig($stateProvider) {
        ...
        .state('region-my-suffix', {
            ...
            data: {
                ...
                pageTitle: 'demo2App.region.home.title'
            },
            views: {
                'content@': {
        ...
        .state('region-my-suffix-detail', {
            ...
            data: {
                authorities: ['ROLE_USER'],
                pageTitle: 'demo2App.region.detail.title'
            },
            views: {
                'content@': {
                    templateUrl: 'app/entities/region/region-my-suffix-detail.html',
        ...
        .state('region-my-suffix-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/region/region-my-suffix-dialog.html',
        ...
        .state('region-my-suffix.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/region/region-my-suffix-delete-dialog.html',
