    ...
    function stateConfig($stateProvider) {
        ...
        .state('employee-my-suffix', {
            ...
            data: {
                ...
                pageTitle: 'demo2App.employee.home.title'
            },
            views: {
                'content@': {
        ...
        .state('employee-my-suffix-detail', {
            ...
            data: {
                authorities: ['ROLE_USER'],
                pageTitle: 'demo2App.employee.detail.title'
            },
            views: {
                'content@': {
                    templateUrl: 'app/entities/employee/employee-my-suffix-detail.html',
        ...
        .state('employee-my-suffix-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/employee/employee-my-suffix-dialog.html',
        ...
        .state('employee-my-suffix.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/entities/employee/employee-my-suffix-delete-dialog.html',
